...
export const LEGEND_RECORDS: LegendRecord[] = [
  ...
  {
    title: "歴代記録: 300時間の耐久VC",
    detail: "前回記録(293時間56分19秒)を更新したボイスチャット滞在記録(当時)。後に512時間の記録に更新されました。",
    date: "2026年6月25日",
  },
  {
    title: "新記録: 512時間の耐久VC",
    detail: "前回記録(300時間)を更新した、矢張市史上最長のボイスチャット滞在記録。ボイスチャンネル「一般」にて達成されました。詳細は写真とあわせてフォトギャラリーでも公開中です。",
    date: "2026年8月17日",
  },
];
